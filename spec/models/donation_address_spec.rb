  ...
  describe '寄付情報の保存' do
    ...
    context '登録できないとき' do
      ...
      it 'postal_codeが半角のハイフンを含んだ正しい形式でないと保存できないこと' do
        ...
        @donation_address.valid?
        expect(@donation_address.errors.full_messages).to include("Postal code ちがうよ〜")
      end

      it 'prefectureを選択していないと保存できないこと' do
        @donation_address.prefecture = 0
        @donation_address.valid?
        expect(@donation_address.errors.full_messages).to include( "Prefecture 変だよ〜〜〜" )
      end
      ...
      it 'priceが全角数字だと保存できないこと' do
        @donation_address.price = '１０００'
        @donation_address.valid?
        expect(@donation_address.errors.full_messages).to include("Price おかしいよ〜")
      end
      ...
      it 'priceが1,000,000円を超過すると保存できないこと' do
        @donation_address.price = 1_000_001
        @donation_address.valid?
        expect(@donation_address.errors.full_messages).to include("Price おかしいよ〜")
      end
    end
